jQuery(function($) {
  ...
  BRUSHED.slider = function() {
    $.supersized({
      ...
      transition : 1, // 0-None, 1-Fade, 2-Slide Top, 3-Slide Right, 4-Slide
                      // Bottom, 5-Slide Left, 6-Carousel Right, 7-Carousel Left
      transition_speed : 300, // Speed of transition
      new_window : 1, // Image links open in new window/tab
      pause_hover : 0, // Pause slideshow on hover
      keyboard_nav : 1, // Keyboard navigation on/off
      performance : 1, // 0-Normal, 1-Hybrid speed/quality, 2-Optimizes image
                        // quality, 3-Optimizes transition speed // (Only works
                        // for Firefox/IE, not Webkit)
      image_protect : 1, // Disables image dragging and right click with
                          // Javascript
  ...
  // var ticker = function() {
  // setTimeout(function() {
  // ul.find('li:first').animate( {marginTop: valueTop + 'px'}, 500, 'linear',
  // function() {
